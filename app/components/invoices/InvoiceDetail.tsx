              ...
              const email =
                ...
                (typeof invoiceData.customerId === "object"
                  ? invoiceData.customerId?.email ||
                    invoiceData.customerId?.contacts?.[0]?.email
                  : "");
    ...
    <View className="flex-1 bg-white">
      ...
      >
        <Pressable style={{ flex: 1 }} onPress={() => setShowMenu(false)}>
          <View className="absolute right-3 top-14 bg-white rounded-md shadow-xl border border-slate-100 py-2 min-w-[280px]">
            <Pressable
              onPress={() => {
                setShowMenu(false);
                router.push({
            ...
            <Pressable
              onPress={() => {
                ...
                const templateData =
                  ...
                  typeof invoiceData.templateId === "object"
                    ? invoiceData.templateId
                    : undefined;
